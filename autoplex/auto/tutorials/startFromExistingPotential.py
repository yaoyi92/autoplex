...
existing_pot = PhononMLCalculationJob(structure=structure, displacements=[0.1], min_length=20, ml_dir="/path/to/your/GAP/pot/gap.xml")

tutorial_flow = Flow([existing_pot],  output = None, name = name +'-AutoPLEX-Flow', uuid = None, hosts = None)
