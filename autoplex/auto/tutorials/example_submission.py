...
complete_flow = CompleteWorkflow(n_struc=1, displacements=[0.1], symprec=0.1, sc=False).make(structure_list=struc_list, mpids=mpids, phonon_displacement_maker=phonon_stat)


autoplex_flow = Flow([complete_flow],  output = None, name = 'Si-AutoPLEX-Flow', uuid = None, hosts = None)
